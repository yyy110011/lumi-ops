...
- **🔌 MCP Server** — `npx @lumi-ops/mcp-server` exposes the entire lifecycle to your AI. Your main agent can autonomously spawn clones, review their diffs, and merge them.
