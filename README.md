...
- **Prompt Library** — Save and reuse task descriptions as templates. Dual-scope storage (Global `~/.lumi-ops/prompts/` + Project `.lumi-ops/prompts/`). Select prompts from a dropdown, import folders, and move between scopes.
